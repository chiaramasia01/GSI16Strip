...
//***********************************************************
Strip16UnpackParam::Strip16UnpackParam() : TGo4Parameter("Parameter")
{
  frP1=0;
  frP2=0;
  fiNum=0;
...
//***********************************************************
Strip16UnpackParam::Strip16UnpackParam(const char* name) : TGo4Parameter(name)
{
  fill=kTRUE;
  frP1=10;
  frP2=20;
...
//***********************************************************
Strip16UnpackParam::~Strip16UnpackParam()
{
}
//***********************************************************

//-----------------------------------------------------------
Int_t Strip16UnpackParam::PrintParameter(Text_t * n, Int_t){
  return 0;
...
//-----------------------------------------------------------
Bool_t Strip16UnpackParam::UpdateFrom(TGo4Parameter *pp){
  if(pp->InheritsFrom("Strip16UnpackParam"))
  {
    Strip16UnpackParam * from;
    from = (Strip16UnpackParam *) pp;
    cout << "**** Strip16UnpackParam " << GetName() << " updated from auto save file" << endl;
    fill=from->fill;
    frP1=from->frP1;
    frP2=from->frP2;
    fiNum=from->fiNum;
